        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text('Select any work to add today\'s progress'),
            ],
          ),
        ),
        Container(
          ...
          child: Row(
            children: [
              Container(
                ...
                padding: EdgeInsets.all(hasCustomImage ? 0 : 18),
                child: Image(
