class RateFileMaterial {
  ...
  factory RateFileMaterial.fromJson(Map<String, dynamic> json) {
    ...
    final parsedDisplayOrder = rawDisplayOrder == null
        ? -1
        : (rawDisplayOrder is int
            ? rawDisplayOrder
            : int.tryParse('$rawDisplayOrder') ?? -1);
...
class RateVariant {
  ...
  factory RateVariant.fromJson(Map<String, dynamic> json) {
    return RateVariant(
      ...
      sizeRange: json['sizeRange'] is Map
          ? Map<String, dynamic>.from(json['sizeRange'])
          : null,
      thicknessRange: json['thicknessRange'] is Map
          ? Map<String, dynamic>.from(json['thicknessRange'])
          : null,
    );
  }
}
