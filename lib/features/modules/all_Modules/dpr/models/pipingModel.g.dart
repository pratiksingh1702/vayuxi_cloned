...
part of 'pipingModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class PipingItemAdapter extends TypeAdapter<PipingItem> {
  @override
  final int typeId = 0;

  @override
  PipingItem read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, PipingItem obj) {
    writer
      ..writeByte(19)
      ..writeByte(0)
      ..write(obj.id)
