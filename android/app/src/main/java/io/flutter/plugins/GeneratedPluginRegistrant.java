...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.ujwal.download_path_provider.DownloadPathProviderPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin download_path_provider, com.ujwal.download_path_provider.DownloadPathProviderPlugin", e);
    }
    try {
